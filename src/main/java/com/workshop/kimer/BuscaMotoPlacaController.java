...
public class BuscaMotoPlacaController implements Initializable {
    ...
    public void onBtBuscaAction(ActionEvent event) {
        try {
            String nome = Utils.removerCaracteresEspeciais(txtPlaca.getText());

            listaMotoClienteController.setListaBusca(motoClienteService.findByPlaca(nome));
